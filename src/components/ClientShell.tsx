  ...
  return (
    <div className="min-h-screen text-white">
      <div className="mx-auto flex min-h-screen max-w-7xl flex-col md:flex-row">
        ...
        <aside
          className={`fixed inset-y-0 left-0 z-50 h-dvh w-[88vw] max-w-sm transform overflow-y-auto border-r border-white/10 bg-slate-950 p-5 shadow-2xl transition-transform duration-200 md:static md:z-auto md:flex md:h-auto md:w-80 md:shrink-0 md:flex-col md:border-r md:bg-white/5 md:p-6 ${
        ...
        >
          ...
          <div className="mt-8 flex-1 overflow-hidden">
            ...
            <div className="mt-3 max-h-[42vh] space-y-2 overflow-auto pr-1 md:max-h-[48vh]">
